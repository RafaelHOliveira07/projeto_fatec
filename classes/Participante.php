...
class Participante
{
   ...
   public function listar()
    {
        $sql = "SELECT * FROM tb_prof p JOIN tb_participantes pa ON p.prof_id = pa.prof_id JOIN tb_edital e ON pa.edital_id = e.edital_id JOIN tb_cursos c ON e.curso_id = c.curso_id ORDER BY part_id";
