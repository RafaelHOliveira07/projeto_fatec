...
class Edital
{
    ...
    {
        $sql = "SELECT e.edital_id, c.sigla_curso, d.nome_disci, d.area_disci,d.data_hora, e.num_edital  FROM tb_edital e JOIN tb_disciplinas d ON e.disci_id = d.disci_id JOIN tb_cursos c ON e.curso_id = c.curso_id ORDER BY edital_id";
